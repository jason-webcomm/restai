...
EMBEDDINGS = {
    ...
    "openai_3_large": (OpenAIEmbeddings, {"model": "text-embedding-3-large"}, "public", "https://platform.openai.com/docs/guides/embeddings", 1536),
    ...
    "bge-m3": (HuggingFaceEmbeddings, {"model_name": "BAAI/bge-m3"}, "private", "https://github.com/FlagOpen/FlagEmbedding", 1024),
}
